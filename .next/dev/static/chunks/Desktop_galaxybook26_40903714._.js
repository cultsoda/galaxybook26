...
function LuckyDrawPage() {
    _s();
    const [prizes, setPrizes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$galaxybook26$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialPrizes);
    ...
    const drawPrize = ()=>{
        ...
        setPrizes((prev)=>prev.map((p)=>p.id === drawnPrize.id ? {
                    ...p,
...
_s(LuckyDrawPage, "WcCc9NGo8hxzrGZoQ03MTv8b8Xk=");
_c = LuckyDrawPage;
var _c;
